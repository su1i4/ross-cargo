  ...
  return (
    <div className="mt-14 w-full relative">
      <Image
        ...
        height={300}
        src="/Calculator.png"
        alt="Калькулятор стоимости доставки грузов из Кыргызстана и Китая в Россию"
      ...
      <div className="absolute inset-0 bg-black/20 rounded-[30px] justify-end px-[30px] py-[30px] gap-[20px] hidden lg:flex">
        <div className="bg-[#FFFFFF] rounded-[30px] p-[30px] flex flex-col w-[800px] gap-[20px]">
          ...
          <p className="text-[#CBCBCB] text-[14px]">
            Нажимая кнопку рассчитать стоимость вы соглашаетесь с обработкой персональных данных, политикой конфиденциальности и публичной офертой
          </p>
        </div>
      </div>
