...
const BuisenessData = [
  {
    icon: <Image src={Warehouse} alt="Truck" width={50} height={50} />,
  ...
  {
    icon: <Image src={Package} alt="Hand" width={50} height={50} />,
  ...
  return (
    <div className="bg-[#F8F8F8] py-16 px-8">
      <div className="container mx-auto">
        <p className="text-[#030115] text-[48px] font-[600]">Фулфилмент</p>
